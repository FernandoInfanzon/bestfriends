...
$("#activarModalKinder").click(function() {
    $("#modalKinder").modal("show");
});


$("#btnAgendarKinder").click(function() {
    $("#modalKinder").modal("hide");
});



$("#activarModalMaternal").click(function() {
    $("#modalMaternal").modal("show");
});


$("#btnAgendarMaternal").click(function() {
    $("#modalMaternal").modal("hide");
});
